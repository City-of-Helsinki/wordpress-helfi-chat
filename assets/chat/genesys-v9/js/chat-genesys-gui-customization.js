    ...
    helfiChat_lang = genesys_settings.language_code;
    //helfiChat_lang = 'fi';
    ...
    var helFiChat_button = "";
        ...
        var helFiChat_service = genesys_settings.service_string;
   ...
   function generateStartChatButton() {
    ...
    window._genesys.widgets = {
        main: {
            ...
            mobileMode: "auto",
            lang: helfiChat_lang,
            i18n: genesys_settings.localization,
            mobileModeBreakpoint: 600,
            preload: ["webchat"]
        },
        webchat: {
            dataURL: genesys_settings.dataURL,
